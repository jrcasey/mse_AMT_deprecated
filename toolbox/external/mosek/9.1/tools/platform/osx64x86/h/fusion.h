...
virtual monty::rc_ptr< ::mosek::fusion::RangeDomain > __mosek_2fusion_2RangeDomain__withShape(int d0,int d1,int d2) ;
monty::rc_ptr< ::mosek::fusion::RangeDomain > withShape(int d0,int d1,int d2);
virtual monty::rc_ptr< ::mosek::fusion::RangeDomain > __mosek_2fusion_2RangeDomain__withShape(int d0,int d1) ;
monty::rc_ptr< ::mosek::fusion::RangeDomain > withShape(int d0,int d1);
virtual monty::rc_ptr< ::mosek::fusion::RangeDomain > __mosek_2fusion_2RangeDomain__withShape(int d0) ;
monty::rc_ptr< ::mosek::fusion::RangeDomain > withShape(int d0);
...
virtual monty::rc_ptr< ::mosek::fusion::LinearDomain > __mosek_2fusion_2LinearDomain__withShape(int d0,int d1,int d2) ;
monty::rc_ptr< ::mosek::fusion::LinearDomain > withShape(int d0,int d1,int d2);
virtual monty::rc_ptr< ::mosek::fusion::LinearDomain > __mosek_2fusion_2LinearDomain__withShape(int d0,int d1) ;
monty::rc_ptr< ::mosek::fusion::LinearDomain > withShape(int d0,int d1);
virtual monty::rc_ptr< ::mosek::fusion::LinearDomain > __mosek_2fusion_2LinearDomain__withShape(int d0) ;
monty::rc_ptr< ::mosek::fusion::LinearDomain > withShape(int d0);
